...
These model-family differences are not causal evidence about sequence mixing: at the 2.8B scale, depth, RoPE usage, and recurrent-state design and size remain confounded.
\end{abstract}
...
Prior work links lost-in-the-middle behavior to U-shaped attention patterns \citep{hsieh2024found}, but our near-2.8B model-family comparison still confounds sequence mixing with depth, RoPE usage, recurrent-state design and size, and checkpoint family \citep{su2024roformer,press2022alibi}.
...
Second, we find a paired difference in primacy profiles among Pile-trained models near 2.8B, subject to those confounds, and examine its direction with a more tightly matched 8B pure/hybrid pair.
...
On 200 exploratory Pythia questions, sham-gold accuracy was $0.1235$, within $0.0285$ of the $0.0950$ closed-book floor; primacy was $+0.0050$ (95\% CI $[-0.0325,0.0425]$) and recency was $-0.0175$ (95\% CI $[-0.0500,0.0125]$).
The distractor-order control's permutation accuracies were $0.2850$, $0.3000$, and $0.2767$, a maximum spread of $0.0233$.
Both controls passed their prespecified gates on Pythia; they do not test the 8B Megatron checkpoints.
